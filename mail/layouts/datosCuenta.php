...
<div style="color:#404041;line-height:120%;font-family:'Helvetica Neue', Helvetica, Arial, sans-serif; padding-right: 15px; padding-left: 15px; padding-top: 15px; padding-bottom: 15px;">	
	...
	<p style="margin: 0;font-size: 12px;line-height: 14px">
		Bienvenido <span style="font-size: 12px; line-height: 14px;">Doctor</span> <?=$nombre . " " . $apellido?>.</p><p style="margin: 0;font-size: 12px;line-height: 14px">&nbsp;<br></p><p style="margin: 0;font-size: 12px;line-height: 14px">Hemos recibido la solicitud de tu usuario y contraseña.</p><p style="margin: 0;font-size: 12px;line-height: 14px">&nbsp;<br></p><p style="margin: 0;font-size: 12px;line-height: 14px"><strong><span style="font-size: 16px; line-height: 19px;">Tu información de la cuenta:</span></strong><br></p><p style="margin: 0;font-size: 12px;line-height: 14px">Usuario: <strong><?=$email?></strong><br>contraseña: <strong><?=$password?></strong></p><p style="margin: 0;font-size: 12px;line-height: 14px">&nbsp;<br></p><p style="margin: 0;font-size: 12px;line-height: 14px">&nbsp;<br></p><p style="margin: 0;font-size: 12px;line-height: 14px">Este correo se genera automáticamente. Favor de no responder.</p><p style="margin: 0;font-size: 12px;line-height: 14px">&nbsp;<br></p><p style="margin: 0;font-size: 12px;line-height: 14px;text-align: right"><em>- Saludos de parte del equipo de Springer&nbsp;healthcare</em></p></div>	
</div>
